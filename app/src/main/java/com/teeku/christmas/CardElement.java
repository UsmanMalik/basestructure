...
import com.teeku.christmas.Adapter.CustomListAdapter;
...
import com.teeku.christmas.utilities.RecyclerItemClickListener;
...
//            db.truncateTables();
//            int countCategoryTest = db.getCategoryCount();
//            Log.e("Category count test: ", countCategoryTest+"");
...
//        rv.setLayoutManager(llm);
    ...
    private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog.setTitle("Downlaoding data..");
